...
/**
 * If you do not specify a url then you must handle ajax on your own. This is
 * how to use js bindings in a async fashion.
 */
...
Thrift.Transport.prototype = {
    ...
    jqRequest : function(client, postData, args, recv_method) {
        ...
        var argsArr = jQuery.makeArray(args);
        ...
        var jqXHR = jQuery.ajax({
            ...
            context : client,
            success : argsArr[argsArr.length - 2],
            error : argsArr[argsArr.length - 1]
        });
...
Thrift.Protocol.prototype = {
    ...
    writeMessageBegin : function(name, messageType, seqid) {
        ...
        this.tstack.push([ Thrift.Protocol.Version, '"' + name + '"',
            messageType, seqid ]);
    },
        ...
        if (str === null) {
            ...
            for ( var i = 0; i < str.length; i++) {
                ...
                if (ch === '\"') {
                    ...
                    escapedString += '\\\\'; // write out as: \\
                    /*
                     * Currently escaped forward slashes break TJSONProtocol. As
                     * it stands, we can simply pass forward slashes into our
                     * strings across the wire without being escaped. I think
                     * this is the protocol's bug, not thrift.js } else if(ch
                     * === '/') { // a single forward slash: / escapedString +=
                     * '\\/'; // write out as \/ }
                     */
